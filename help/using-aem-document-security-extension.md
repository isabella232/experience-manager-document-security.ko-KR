...
Document Security 웹 페이지를 사용하여 동적 워터마크를 만듭니다. 정책으로 보호된 문서에 동적 워터마크를 만들고 포함하는 방법에 대한 자세한 내용은 [Document Security 최종 사용자 도움말](http://www.adobe.com/go/learn_lc_euRightsMgmt_11_kr)을 참조하십시오.
...
JEE 용어에 대한 LiveCycle 및 AEM Forms에 대한 자세한 내용은 [용어집](http://www.adobe.com/go/learn_aemforms_designer_65_kr)을 참조하십시오.
