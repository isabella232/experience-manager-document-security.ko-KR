...
AEM 사용 또는 기술 오류에 대한 질문은 를 통해 일반적인 지원 프로세스를 통해 보고해야 합니다 [Experience Manager 지원 포털](https://experienceleague.adobe.com/?support-solution=Experience+Manager#home) 또는 [Experience Manager 커뮤니티](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community).

***AEM 설명서 기여는 Adobe 고객 지원을 대체하지 않습니다*** 지원 관련 질문에 대한 답변을 구하는 기여는 모두 거부됩니다.
